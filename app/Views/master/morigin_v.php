                        ...
                        <div class="">
                            ...
                            <form class="form-horizontal" method="post" enctype="multipart/form-data">                                                     
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="origin_name">Nama:</label>
                                    <div class="col-sm-10">
                                        <input required type="text" autofocus class="form-control" id="origin_name" name="origin_name" placeholder="" value="<?= $origin_name; ?>">
                                    </div>
                                </div>    
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        ...
                                        <a class="btn btn-warning col-md-offset-1 col-md-5" href="<?= base_url("morigin"); ?>">Back</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                                            ...
                                            <?php if (!isset($_GET["report"])) { ?>
                                                <td style="padding-left:0px; padding-right:0px;">
                                                    ...
                                                    <form method="post" class="btn-action" style="">
                                                        ...
                                                        <input type="hidden" name="origin_id" value="<?= $usr->origin_id; ?>" />
                                                    </form>
                                                    <?php }?>
