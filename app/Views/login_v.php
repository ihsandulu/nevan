...
<head>
    ...
    <style>
        ...
        .container-login100 {
            background-image: url('images/global/background_nkl.png'); /* Gantilah 'nama_gambar.jpg' dengan nama dan path file gambar Anda */
        ...
        #logo{width:auto; height:150px; margin: 0px;}
        .gambarlogo{padding: 0px;}
        .login100-form-title{
            padding-top: 25px;
            padding-bottom:25px;
        }
